      ...
      <>
        ...
        <section>
          <div className='searchbar'>
            <input type='text' placeholder='sairam cards...' name='searchkey' value={searchkey} onChange={(e) => this.handleSearch(e)} />
          </div>
          <div className='grid'>
        ...
        <footer>
          Copyright @ 2025.All Rights Reserved <sub>- Tejith Lagadapati</sub>
        </footer>
      </>
    )
  }
